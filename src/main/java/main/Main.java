...
public final class Main extends JavaPlugin {
    ...
    public void onEnable() {
        try {
            ...
            GOLDEN_APPLE = customItem(Material.GOLDEN_APPLE, 16, "§e황금 사과", Arrays.asList("§7섭취 시:", "§8- §d재생 III §9(0:04)", "§8- §a포화 V §e(§2허기 §a5 §e회복, §5포만감 §a10 §e회복)"), true, null, true);
                                ...
                                public void run() {
                                    try {
                                        if (!InvOpenCDHandler.getInvOpenCooldoawn().containsKey(p)) {
                                            ...
                                            gui.setItem(14, Main.customItem(Material.DIAMOND_SWORD, 1, "§c하드코어 모드", Arrays.asList("§b일반 모드의 어려운 버전입니다.", "§a좀비들의 §c공격력§a이 강해지고 §9속도§a가 빨라지며", "§e백신§a을 사용할 수 §c없습니다§a.", "", "§e▶ §6클릭해서 게임 시작하기"), true, null, false));
